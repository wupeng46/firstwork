...
/**
 * Boxinplace entity. @author MyEclipse Persistence Tools
 */

public class Boxinplace implements java.io.Serializable {
	...
	/** minimal constructor */
	public Boxinplace(String boxinplaceid) {
		this.boxinplaceid = boxinplaceid;
	}

	/** full constructor */
	public Boxinplace(String boxinplaceid, String weighid, String carnumber,
			...
			Timestamp inplacetime, String isvalid, String cancelreason,
