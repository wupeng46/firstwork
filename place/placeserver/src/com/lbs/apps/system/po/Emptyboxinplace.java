...
/**
 * Emptyboxinplace entity. @author MyEclipse Persistence Tools
 */

public class Emptyboxinplace implements java.io.Serializable {
	...
	/** default constructor */
	public Emptyboxinplace() {
	}

	/** minimal constructor */
	public Emptyboxinplace(String emptyboxinplaceid) {
		this.emptyboxinplaceid = emptyboxinplaceid;
	}

	/** full constructor */
	public Emptyboxinplace(String emptyboxinplaceid, String emptyboxinparkid,
			String boxid, String boxtype, Integer companyid, String placeboxid,
			Timestamp inparktime, Timestamp inplacetime, String isvalid,
