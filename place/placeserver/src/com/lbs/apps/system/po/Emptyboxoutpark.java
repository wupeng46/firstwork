...
/**
 * Emptyboxoutpark entity. @author MyEclipse Persistence Tools
 */

public class Emptyboxoutpark implements java.io.Serializable {

	// Fields

	private String emptyboxoutparkid;
	...
	/** default constructor */
	public Emptyboxoutpark() {
	}

	/** minimal constructor */
	public Emptyboxoutpark(String emptyboxoutparkid, String emptyboxoutplaceid,
			String emptyboxinplaceid) {
		this.emptyboxoutparkid = emptyboxoutparkid;
	...
	public Emptyboxoutpark(String emptyboxoutparkid, String emptyboxoutplaceid,
			...
			Timestamp outplacetime, Timestamp outparktime, String isvalid,
			String cancelreason, Timestamp canceltime, Integer cancelby,
	...
	public String getEmptyboxoutparkid() {
		return this.emptyboxoutparkid;
	}

	public void setEmptyboxoutparkid(String emptyboxoutparkid) {
		this.emptyboxoutparkid = emptyboxoutparkid;
	}
