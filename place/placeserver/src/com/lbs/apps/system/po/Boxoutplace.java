...
/**
 * Boxoutplace entity. @author MyEclipse Persistence Tools
 */

public class Boxoutplace implements java.io.Serializable {
	...
	/** minimal constructor */
	public Boxoutplace(String boxoutplaceid, String boxinplaceid) {
	...
	/** full constructor */
	public Boxoutplace(String boxoutplaceid, String boxinplaceid,
			String weighid, String carnumber, String closenumber, String boxid,
			String orderid, Integer companyid, String goodstype,
			String packagetype, String carriagetype, String conveyance,
			String placeboxid, Timestamp inplacetime, Timestamp outplacetime,
