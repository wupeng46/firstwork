...
/**
 * Receivableapply entity. @author MyEclipse Persistence Tools
 */

public class Receivableapply implements java.io.Serializable {
	...
	/** default constructor */
	public Receivableapply() {
	}

	/** minimal constructor */
	public Receivableapply(String receivableapplyid, String receivableid) {
